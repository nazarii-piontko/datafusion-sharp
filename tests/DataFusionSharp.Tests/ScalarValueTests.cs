...
public sealed class ScalarValueTests : IDisposable
{
    ...
    public static TheoryData<ScalarValue, ArrowTypeId, string> SupportedParameters => new()
    {
        ...
        { (bool?)true, ArrowTypeId.Boolean, "true" },
        ...
        { (float?)3.14f, ArrowTypeId.Float, "3.14" },
        ...
        { (double?)2.71828, ArrowTypeId.Double, "2.71828" },
        ...
        { (long?)1_000_000L, ArrowTypeId.Int64, "1000000" },
        ...
        { (uint?)uint.MaxValue, ArrowTypeId.UInt32, "4294967295" },
        ...
        { (ulong?)ulong.MaxValue, ArrowTypeId.UInt64, "18446744073709551615" },
        ...
        { (DateOnly?)DateOnly.Parse("1970-04-11", CultureInfo.InvariantCulture), ArrowTypeId.Date32, "1970-04-11" },
        ...
        { (decimal?)-1000m, ArrowTypeId.Decimal128, "-1000" },
        ...
        { TimeSpan.FromMilliseconds(1000), ArrowTypeId.Duration, "0 days 0 hours 0 mins 1.000000 secs" },
        { (TimeSpan?)TimeSpan.FromMilliseconds(1000), ArrowTypeId.Duration, "0 days 0 hours 0 mins 1.000000 secs" },
