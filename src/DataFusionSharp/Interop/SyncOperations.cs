...
internal sealed class SyncOperations
{
    ...
    public TResult PeekResult<TResult>(ulong id)
    {
        ...
        return r.Result ?? throw new DataFusionException(DataFusionErrorCode.Panic, "Operation completed without a result");
    }
