...
internal static unsafe partial class NativeMethods
{
    ...
    public static partial DataFusionErrorCode RuntimeNew(
        uint workerThreads,
        uint maxBlockingThreads,
        out IntPtr runtimeHandle);
    ...
    public static partial DataFusionErrorCode Ping(
        RuntimeSafeHandle runtimeHandle,
    ...
    public static partial DataFusionErrorCode ContextRegisterCsv(
        ...
        BytesData optionsData,
        Callback callback,
        IntPtr userData,
        out IntPtr cancellationTokenHandle);

    [LibraryImport(LibraryName, EntryPoint = "datafusion_context_register_json")]
    public static partial DataFusionErrorCode ContextRegisterJson(
        SessionContextSafeHandle contextHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string tableName,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string filePath,
        BytesData optionsData,
    ...
    public static partial DataFusionErrorCode ContextRegisterParquet(
        SessionContextSafeHandle contextHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string tableName,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string filePath,
        BytesData optionsData,
    ...
    public static partial DataFusionErrorCode ContextRegisterBatch(
        SessionContextSafeHandle contextHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string tableName,
        BytesData batchIpcData,
        Callback callback,
        IntPtr userData);

    [LibraryImport(LibraryName, EntryPoint = "datafusion_context_deregister_table")]
    public static partial DataFusionErrorCode ContextDeregisterTable(
        SessionContextSafeHandle contextHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string tableName,
        Callback callback,
        IntPtr userData,
    ...
    public static partial DataFusionErrorCode ContextRegisterObjectStoreLocal(
        SessionContextSafeHandle contextHandle,
    ...
    public static partial DataFusionErrorCode ContextRegisterObjectStoreS3(
        SessionContextSafeHandle contextHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string url,
        BytesData optionsData,
        Callback callback,
    ...
    public static partial DataFusionErrorCode ContextRegisterObjectStoreAzure(
        SessionContextSafeHandle contextHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string url,
        BytesData optionsData,
        Callback callback,
    ...
    public static partial DataFusionErrorCode ContextRegisterObjectStoreGcs(
        SessionContextSafeHandle contextHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string url,
        BytesData optionsData,
        Callback callback,
    ...
    public static partial DataFusionErrorCode ContextRegisterObjectStoreHttp(
        SessionContextSafeHandle contextHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string url,
        BytesData optionsData,
        Callback callback,
    ...
    public static partial DataFusionErrorCode ContextRegisterObjectStoreInMemory(
        SessionContextSafeHandle contextHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string url,
        InMemoryStoreSafeHandle inMemoryStoreHandle,
        Callback callback,
        IntPtr userData);

    [LibraryImport(LibraryName, EntryPoint = "datafusion_context_deregister_object_store")]
    public static partial DataFusionErrorCode ContextDeregisterObjectStore(
        SessionContextSafeHandle contextHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string url,
        Callback callback,
        IntPtr userData);
    ...
    public static partial DataFusionErrorCode DataFrameWithParameters(
        DataFrameSafeHandle dataFrameHandle,
        BytesData paramValuesData,
        Callback callback,
        IntPtr userData);

    [LibraryImport(LibraryName, EntryPoint = "datafusion_dataframe_count")]
    public static partial DataFusionErrorCode DataFrameCount(
        DataFrameSafeHandle dataFrameHandle,
        Callback callback,
        IntPtr userData,
        out IntPtr cancellationTokenHandle);
    ...
    public static partial DataFusionErrorCode DataFrameShow(
        DataFrameSafeHandle dataFrameHandle,
        ulong limit,
        Callback callback,
        IntPtr userData,
    ...
    public static partial DataFusionErrorCode DataFrameSchema(
        DataFrameSafeHandle dataFrameHandle,
        Callback callback,
        IntPtr userData);

    [LibraryImport(LibraryName, EntryPoint = "datafusion_dataframe_collect")]
    public static partial DataFusionErrorCode DataFrameCollect(
        DataFrameSafeHandle dataFrameHandle,
        Callback callback,
        IntPtr userData,
        out IntPtr cancellationTokenHandle);
    ...
    public static partial DataFusionErrorCode DataFrameToString(
        DataFrameSafeHandle dataFrameHandle,
        Callback callback,
        IntPtr userData,
        out IntPtr cancellationTokenHandle);
    ...
    public static partial DataFusionErrorCode DataFrameWriteCsv(
        DataFrameSafeHandle dataFrameHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string path,
        BytesData dataFrameWriteOptionsData,
        BytesData csvWriteOptionsData,
        Callback callback,
        IntPtr userData,
        out IntPtr cancellationTokenHandle);

    [LibraryImport(LibraryName, EntryPoint = "datafusion_dataframe_write_json")]
    public static partial DataFusionErrorCode DataFrameWriteJson(
        DataFrameSafeHandle dataFrameHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string path,
        BytesData dataFrameWriteOptionsData,
        BytesData jsonWriteOptionsData,
        Callback callback,
        IntPtr userData,
        out IntPtr cancellationTokenHandle);

    [LibraryImport(LibraryName, EntryPoint = "datafusion_dataframe_write_parquet")]
    public static partial DataFusionErrorCode DataFrameWriteParquet(
        DataFrameSafeHandle dataFrameHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string path,
        BytesData dataFrameWriteOptionsData,
        BytesData parquetWriteOptionsData,
        Callback callback,
        IntPtr userData,
        out IntPtr cancellationTokenHandle);
    ...
    public static partial DataFusionErrorCode DataFrameExecuteStream(
        DataFrameSafeHandle dataFrameHandle,
        Callback callback,
        IntPtr userData,
        out IntPtr cancellationTokenHandle);
    ...
    public static partial DataFusionErrorCode DataFrameStreamNext(
        DataFrameStreamSafeHandle streamHandle,
        Callback callback,
        IntPtr userData,
        out IntPtr cancellationTokenHandle);
    ...
    public static partial DataFusionErrorCode InMemoryStoreNew(
        RuntimeSafeHandle runtimeHandle,
        out IntPtr inMemoryHandle);
    ...
    public static partial DataFusionErrorCode InMemoryStorePut(
        InMemoryStoreSafeHandle inMemoryHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string path,
        BytesData data,
        [MarshalAs(UnmanagedType.I1)] bool copy,
        Callback callback,
        IntPtr userData,
        out IntPtr cancellationTokenHandle);

    [LibraryImport(LibraryName, EntryPoint = "datafusion_in_memory_store_get")]
    public static partial DataFusionErrorCode InMemoryStoreGet(
        InMemoryStoreSafeHandle inMemoryHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string path,
        Callback callback,
        IntPtr userData,
    ...
    public static partial DataFusionErrorCode InMemoryStoreDelete(
        InMemoryStoreSafeHandle inMemoryHandle,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string path,
        Callback callback,
        IntPtr userData,
