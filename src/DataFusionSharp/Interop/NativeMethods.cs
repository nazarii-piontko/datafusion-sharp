...
internal static unsafe partial class NativeMethods
{
    ...
    public static partial DataFusionErrorCode SetLogger(LogCallback callback);
    ...
    [LibraryImport(LibraryName, EntryPoint = "datafusion_cancellation_token_cancel")]
    [SuppressGCTransition]
    public static partial DataFusionErrorCode CancellationTokenCancel(IntPtr handle);
    
    [LibraryImport(LibraryName, EntryPoint = "datafusion_cancellation_token_destroy")]
    [SuppressGCTransition]
    public static partial DataFusionErrorCode CancellationTokenDestroy(IntPtr handle);
    ...
    public static partial DataFusionErrorCode Ping(RuntimeSafeHandle runtimeHandle, ulong timeoutMilliseconds, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);
    ...
    public static partial DataFusionErrorCode ContextRegisterCsv(SessionContextSafeHandle contextHandle, [MarshalAs(UnmanagedType.LPUTF8Str)] string tableName, [MarshalAs(UnmanagedType.LPUTF8Str)] string filePath, BytesData optionsData, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);
    
    [LibraryImport(LibraryName, EntryPoint = "datafusion_context_register_json")]
    public static partial DataFusionErrorCode ContextRegisterJson(SessionContextSafeHandle contextHandle, [MarshalAs(UnmanagedType.LPUTF8Str)] string tableName, [MarshalAs(UnmanagedType.LPUTF8Str)] string filePath, BytesData optionsData, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);
    
    [LibraryImport(LibraryName, EntryPoint = "datafusion_context_register_parquet")]
    public static partial DataFusionErrorCode ContextRegisterParquet(SessionContextSafeHandle contextHandle, [MarshalAs(UnmanagedType.LPUTF8Str)] string tableName, [MarshalAs(UnmanagedType.LPUTF8Str)] string filePath, BytesData optionsData, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);
    ...
    public static partial DataFusionErrorCode ContextDeregisterTable(SessionContextSafeHandle contextHandle, [MarshalAs(UnmanagedType.LPUTF8Str)] string tableName, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);
    
    [LibraryImport(LibraryName, EntryPoint = "datafusion_context_sql")]
    public static partial DataFusionErrorCode ContextSql(SessionContextSafeHandle contextHandle, [MarshalAs(UnmanagedType.LPUTF8Str)] string sql, BytesData paramValuesData, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);
    ...
    public static partial DataFusionErrorCode DataFrameCount(DataFrameSafeHandle dataFrameHandle, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);
    
    [LibraryImport(LibraryName, EntryPoint = "datafusion_dataframe_show")]
    public static partial DataFusionErrorCode DataFrameShow(DataFrameSafeHandle dataFrameHandle, ulong limit, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);
    ...
    public static partial DataFusionErrorCode DataFrameCollect(DataFrameSafeHandle dataFrameHandle, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);

    [LibraryImport(LibraryName, EntryPoint = "datafusion_dataframe_to_string")]
    public static partial DataFusionErrorCode DataFrameToString(DataFrameSafeHandle dataFrameHandle, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);

    [LibraryImport(LibraryName, EntryPoint = "datafusion_dataframe_write_csv")]
    public static partial DataFusionErrorCode DataFrameWriteCsv(DataFrameSafeHandle dataFrameHandle, [MarshalAs(UnmanagedType.LPUTF8Str)] string path, BytesData dataFrameWriteOptionsData, BytesData csvWriteOptionsData, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);

    [LibraryImport(LibraryName, EntryPoint = "datafusion_dataframe_write_json")]
    public static partial DataFusionErrorCode DataFrameWriteJson(DataFrameSafeHandle dataFrameHandle, [MarshalAs(UnmanagedType.LPUTF8Str)] string path, BytesData dataFrameWriteOptionsData, BytesData jsonWriteOptionsData, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);

    [LibraryImport(LibraryName, EntryPoint = "datafusion_dataframe_write_parquet")]
    public static partial DataFusionErrorCode DataFrameWriteParquet(DataFrameSafeHandle dataFrameHandle, [MarshalAs(UnmanagedType.LPUTF8Str)] string path, BytesData dataFrameWriteOptionsData, BytesData parquetWriteOptionsData, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);

    // Stream

    [LibraryImport(LibraryName, EntryPoint = "datafusion_dataframe_execute_stream")]
    public static partial DataFusionErrorCode DataFrameExecuteStream(DataFrameSafeHandle dataFrameHandle, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);
    ...
    public static partial DataFusionErrorCode DataFrameStreamNext(DataFrameStreamSafeHandle streamHandle, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);
    ...
    public static partial DataFusionErrorCode InMemoryStorePut(InMemoryStoreSafeHandle inMemoryHandle, [MarshalAs(UnmanagedType.LPUTF8Str)] string path, BytesData data, [MarshalAs(UnmanagedType.I1)] bool copy, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);
    
    [LibraryImport(LibraryName, EntryPoint = "datafusion_in_memory_store_get")]
    public static partial DataFusionErrorCode InMemoryStoreGet(InMemoryStoreSafeHandle inMemoryHandle, [MarshalAs(UnmanagedType.LPUTF8Str)] string path, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);
    
    [LibraryImport(LibraryName, EntryPoint = "datafusion_in_memory_store_delete")]
    public static partial DataFusionErrorCode InMemoryStoreDelete(InMemoryStoreSafeHandle inMemoryHandle, [MarshalAs(UnmanagedType.LPUTF8Str)] string path, Callback callback, IntPtr userData, out IntPtr cancellationTokenHandle);
}
